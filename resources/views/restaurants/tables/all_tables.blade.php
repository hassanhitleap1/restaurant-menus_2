            ...
            <div class="row">
                ...
                <div class="col-6 text-right">
                    ...
                    <button onclick="event.preventDefault(); document.getElementById('table_report').submit();"
                            class="btn btn-sm btn-secondary btn-round btn-icon" data-toggle="tooltip"
                                ...
                                <li class="list-group-item px-0">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col">
                                            ...
                                            <a href="{{route('download_tblqr',[Auth::user()->view_id,$data->table_name])}}" class="btn btn-sm btn-primary">QR Code</a>
